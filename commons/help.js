...
const slashHelp = ["ping", "search id", "search name", "list", "cost"].reduce(
...
export default function (command, prefix) {
  ...
  switch (command) {
    ...
    case "equipment":
      helpMessage =
        "Shows information about an equipment based on its `name` or `id`.\n" +
        `\`${prefix}equipment id <id>\` or \`${prefix}equipment name <name>\`\n` +
        `Ex: \`${prefix}equipment id smu102\``;
      break;
    case "list":
